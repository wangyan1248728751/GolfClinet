...
//		add
//		{
//			Action<TFlightData> action;
//			Action<TFlightData> onFlightWasDeleted = this.OnFlightWasDeleted;
//			do
//			{
//				action = onFlightWasDeleted;
//				onFlightWasDeleted = Interlocked.CompareExchange<Action<TFlightData>>(ref this.OnFlightWasDeleted, (Action<TFlightData>)Delegate.Combine(action, value), onFlightWasDeleted);
//			}
//			while ((object)onFlightWasDeleted != (object)action);
//		}
//		remove
//		{
//			Action<TFlightData> action;
...
//			{
//				action = onFlightWasDeleted;
//				onFlightWasDeleted = Interlocked.CompareExchange<Action<TFlightData>>(ref this.OnFlightWasDeleted, (Action<TFlightData>)Delegate.Remove(action, value), onFlightWasDeleted);
//			}
//			while ((object)onFlightWasDeleted != (object)action);
//		}
//	}
